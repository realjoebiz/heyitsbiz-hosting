    ...
    <section className="border-t border-line py-20">
      <div className="mx-auto max-w-2xl px-6 text-center">
        ...
        <p className="mt-5 text-lg leading-relaxed text-inkMuted">
          ...
          price and stops there. It's new and it's small, and that's the actual trade
          you're making: less scale, more directness.
        </p>
        <p className="mt-6 font-semibold text-ink">— Biz, builder of Hosting by Biz</p>
      </div>
    </section>
  );
}
